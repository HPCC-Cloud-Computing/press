...
def evaluate_timeseries(time_series, window_size):
    ...
    print('\n\nTimeseries ({} samples by {} series):\n'.format(nb_samples, nb_series), time_series)
    model = neural_network(window_size=window_size, filter_length=filter_length, nb_input_series=nb_series, nb_outputs=nb_series, nb_filter=nb_filter)
